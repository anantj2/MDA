...
public class RecipeApiTest {
    ...
    public void testForRecipeName() throws Exception {
        ...
        ResponseEntity<Recipe> response = restTemplate.withBasicAuth("admin", "password").getForEntity(
                new URL("http://localhost:" + port + "/kitchenworld/api/recipes/1").toString(), Recipe.class);
    ...
    public void testForRecipeNotFound() throws Exception {
        ResponseEntity<Recipe> response = restTemplate.withBasicAuth("admin", "password").getForEntity(
                new URL("http://localhost:" + port + "/kitchenworld/api/recipes/3000").toString(), Recipe.class);
    ...
    public void testForRecipeSize() throws Exception {
        ...
        ResponseEntity<String> response = restTemplate.withBasicAuth("admin", "password").getForEntity(
                new URL("http://localhost:" + port + "/kitchenworld/api/recipes/size").toString(), String.class);
    ...
    public void testForAddRecipe() throws Exception {
        ...
        Recipe recipe = new RecipeBuilder().withName("test-recipe").withCookingInstruction("test - instructions")
                .withIngredientDescription("test-ingrediens").withImagePath("image/caponata-pasta.jpg")
                .withCreatedAt(LocalDateTime.now()).withCreatedBy(1L).withSuitableFor(PeopleGroup.FIVETOTEN)
                .withIsVegetarian(true).build();

        RequestEntity<Recipe> requestEntity = RequestEntity
                .post(new URI("http://localhost:" + port + "/kitchenworld/api/recipes/")).body(recipe);

        ResponseEntity<Recipe> response = restTemplate.withBasicAuth("admin", "password").exchange(requestEntity,
                Recipe.class);
    ...
    public void testForUpdateRecipe() throws Exception {
        Recipe recipe = new RecipeBuilder().withId(2L).withName("Updated Coconut dhansak").withUpdatedBy(2L)
                .withSuitableFor(PeopleGroup.MORETHANTEN).withIsVegetarian(false).build();

        RequestEntity<Recipe> requestEntity = RequestEntity
                .put(new URI("http://localhost:" + port + "/kitchenworld/api/recipes/2")).body(recipe);
    ...
    public void testForDeleteRecipe() throws Exception {
        ...
        ResponseEntity<Void> response = restTemplate.withBasicAuth("admin", "password").exchange(requestEntity,
                Void.class);
    ...
    public void testForUpdateWithoutRecipeName() throws Exception {
        Recipe recipe = new RecipeBuilder().withId(2L).withUpdatedBy(2L).withSuitableFor(PeopleGroup.MORETHANTEN)
                .withIsVegetarian(false).build();
    ...
    public void testForGetWithoutAuthorization() throws Exception {
        ResponseEntity<Recipe> response = restTemplate.getForEntity(
                new URL("http://localhost:" + port + "/kitchenworld/api/recipes/1").toString(), Recipe.class);
    ...
    public void testForPostWithoutAdminRights() throws Exception {
        ...
        ResponseEntity<Recipe> response = restTemplate.withBasicAuth("user", "password").exchange(requestEntity,
                Recipe.class);
    ...
    public void testForDeleteWithoutAdminRights() throws Exception {
        ...
        ResponseEntity<Void> response = restTemplate.withBasicAuth("user", "password").exchange(requestEntity,
                Void.class);
        assertEquals(HttpStatus.FORBIDDEN, response.getStatusCode());
    }
    ...
    public void testForGetWithoutAdminRights() throws Exception {
        ResponseEntity<Recipe> response = restTemplate.withBasicAuth("user", "password").getForEntity(
                new URL("http://localhost:" + port + "/kitchenworld/api/recipes/1").toString(), Recipe.class);
