...
public class RecipeBuilder {
    ...
    public Recipe build() {
        return new Recipe(rcpId, rcpName, rcpIngredientDescription, rcpCookingInstruction, rcpImagePath,
                rcpIsVegetarian, rcpSuitableFor, rcpCreatedBy, rcpCreatedAt, rcpUpdatedBy, rcpUpdatedAt, rcpRowState);
    }
}
