...
public class RecipeServiceTest {
    ...
    public void testAddRecipe() throws Exception {
        Recipe recipe = new RecipeBuilder().withId(1L).withName("Recipe 1").build();
    ...
    public void testDeleteRecipe() throws Exception {
        Recipe recipe = new RecipeBuilder().withId(1L).withName("Recipe 1").withRowState(1).withUpdatedBy(2L).build();
        Recipe deletedRecipe = new RecipeBuilder().withId(1L).withName("Recipe 1").withRowState(-1).withUpdatedBy(1L)
                .build();
    ...
    public void testGetRecipeById() throws Exception {
        Recipe recipe = new RecipeBuilder().withId(1L).withName("Caponata Pasta")
                .withIngredientDescription("olive oil,onion,tomatoes,small capers,raisins,rigatoni")
                .withImagePath("image/caponata-pasta.jpg").build();
    ...
    public void testGetAllRecipe() throws Exception {
        Recipe recipe = new RecipeBuilder().withId(1L).withName("Recipe 1").build();
        Recipe recipe1 = new RecipeBuilder().withId(1L).withName("Recipe 2").build();
        Recipe recipe2 = new RecipeBuilder().withId(1L).withName("Recipe 3").build();
