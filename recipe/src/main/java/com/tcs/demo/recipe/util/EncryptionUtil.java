...
public class EncryptionUtil {
    ...
    // LogManager.getLogger(EncryptionUtil.class);
     ...
     * IllegalBlockSizeException, BadPaddingException) occurs
     * 
     * @param textToDecrypt
     * @return
     * @throws GeneralSecurityException
    ...
    /*
     * public static void main(String[] args) throws Exception { String s = encrypt("password@1234");
     * System.out.println(s); System.out.println(s+" "+decrypt("qaPGe16uwLOPfVSd1y0Img=="));
     * 
