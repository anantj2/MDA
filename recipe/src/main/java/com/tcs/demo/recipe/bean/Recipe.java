...
public class Recipe implements Serializable {
    ...
    /**
     * @param rcpIngredientDescription
     *            the rcpIngredientDescription to set
     */
    ...
    /**
     * @param rcpCookingInstruction
     *            the rcpCookingInstruction to set
     */
    ...
    /**
     * @param rcpIsVegetarian
     *            the rcpIsVegetarian to set
     */
    ...
    /**
     * @param rcpSuitableFor
     *            the rcpSuitableFor to set
     */
