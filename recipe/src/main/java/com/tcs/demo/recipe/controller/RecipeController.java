...
public class RecipeController {
    ...
    public ResponseEntity<?> saveRecipeWithMultiPart(@Valid @RequestPart Recipe recipe,
        ...
        URI uri = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(recipe.getRcpId())
                .toUri();
    ...
    /**
     * Update a recipe with Recipe object and set the updatedby property to {principal/loggedin user if updatedby is not
     * passed to the api}
     * 
     * @mapsTo /kitchenworld/api/recipes/{id}
     * @param id
    ...
    /**
     * Update recipeid with Recipe object and image file and set the updatedby property to {principal/loggedin user} if
     * updatedby is not passed to the api} /kitchenworld/api/recipes/{id}
     * 
     * @param id
     * @param recipe
     * @param uploadFile
    ...
    public ResponseEntity<?> updateRecipe(@PathVariable("id") Long id, @Valid @RequestPart Recipe recipe,
